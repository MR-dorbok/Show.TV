...
<div class="col-12 p-3">
    ...
    <!-- زر التعديل -->
        ...
        <a href="{{ route('admin.users.edit', $user->id) }}" class="btn btn-outline-success btn-sm">Edit</a>
    ...
    <!-- زر المسح -->
        ...
        <form action="{{ route('admin.users.destroy', $user->id) }}" method="POST" style="display: inline-block;">
            @csrf
            @method('DELETE')
            <button type="submit" class="btn  btn-outline-danger btn-sm font-small mx-1" onclick="return confirm('هل أنت متأكد من رغبتك في حذف هذا المستخدم؟')">Delete</button>
        </form>
